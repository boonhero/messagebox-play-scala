...
var MessageForm = React.createClass({
    handleSubmit: function (e) {
        ...
        var saveUrl = "http://localhost:9000/box";
        $.ajax({
            url: saveUrl,
            method: 'POST',
            dataType: 'json',
...
React.render(<MessageForm url="http://localhost:9000/box" />, document.getElementById('createMessage'));
React.render(<MessageList url="http://localhost:9000/box" pollInterval={2000} />, document.getElementById('messageList'));